...
fun main(args: Array<String>) {
    ...
    t(5, 5);
    println(t); // Kotlin reflection is not available: need to use maven dependency kotlin-reflect.
                // Now I receive message: fun sumNumbers(kotlin.Int, kotlin.Int): kotlin.Int
    printResult(t, 4, 2); // Resul: 6. As expected.
}